		...
		extend: {
			colors: {
				...
				category: {
					...
					proteins: 'hsl(var(--category-proteins))',
					'proteins-foreground': 'hsl(var(--category-proteins-foreground))',
					...
					'drinks-foreground': 'hsl(var(--category-drinks-foreground))',
					services: 'hsl(var(--category-services))',
					'services-foreground': 'hsl(var(--category-services-foreground))',
					vegetarian: 'hsl(var(--category-vegetarian))',
					'vegetarian-foreground': 'hsl(var(--category-vegetarian-foreground))',
				},
				service: {
