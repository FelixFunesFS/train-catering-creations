-- Fix critical database security and access issues with proper UUID

-- Use a proper UUID for dev user
-- This UUID will be consistent and recognizable as dev: 00000000-0000-0000-0000-000000000001
INSERT INTO public.user_roles (user_id, role, granted_by)
VALUES ('00000000-0000-0000-0000-000000000001', 'admin', '00000000-0000-0000-0000-000000000001')
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM public.user_roles WHERE user_id = dev_user_id AND role = 'admin') THEN
        INSERT INTO public.user_roles (user_id, role, granted_by)
        VALUES (dev_user_id, 'admin', dev_user_id)
        ON CONFLICT (user_id, role) DO NOTHING;
    END IF;
