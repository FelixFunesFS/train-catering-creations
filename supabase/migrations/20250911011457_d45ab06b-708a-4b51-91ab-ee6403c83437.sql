-- Temporarily disable the problematic trigger to allow status updates
DROP TRIGGER IF EXISTS update_quote_status_trigger ON quote_requests;
...
-- Recreate the trigger with proper status mapping
