-- Drop all problematic triggers that might reference non-existent enum types
DROP TRIGGER IF EXISTS update_quote_request_status_trigger ON quote_requests;
DROP TRIGGER IF EXISTS sync_quote_workflow_status ON quote_requests;
