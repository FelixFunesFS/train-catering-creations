...
('22222222-2222-2222-2222-222222222222', 'Michelle Rodriguez', 'michelle.rodriguez@charlestontech.com',
 '843-555-0456', 'Tech Company Picnic', 'corporate', '2025-11-20', '11:00:00',
...
INSERT INTO public.invoice_line_items (invoice_id, category, title, description, quantity, unit_price, total_price) VALUES
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'proteins', 'Fried Chicken', 'Southern-style fried chicken', 150, 15, 2250),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'sides', 'Collard Greens', 'Traditional Southern greens', 150, 5, 750),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'proteins', 'Pulled Pork', 'Carolina BBQ pulled pork', 75, 14, 1050);

-- Payment Milestones (UPPERCASE)
...
INSERT INTO public.change_requests (id, invoice_id, customer_email, request_type, priority,
  ...
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
   ...
   '{"change_type": "guest_count"}', 'Can we add 15 more guests?', 1340, NOW() - INTERVAL '2 days');