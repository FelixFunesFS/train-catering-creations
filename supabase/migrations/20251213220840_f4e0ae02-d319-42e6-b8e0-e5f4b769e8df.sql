-- Fix invoice_payment_summary view to include draft invoices for EstimateEditor
...
COMMENT ON VIEW public.invoice_payment_summary IS 'Invoice payment summary including drafts for estimate editing and AR dashboard';