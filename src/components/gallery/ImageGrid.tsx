  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 md:gap-3 mb-12">
      {images.map((image, index) => (
        <Card 
          key={index} 
          className="shadow-card hover:shadow-elegant bg-card border-2 border-transparent group-hover:border-primary/20 transition-all duration-200 cursor-pointer group min-h-[240px] sm:min-h-[280px] xl:min-h-[240px]"
