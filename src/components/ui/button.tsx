  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-semibold transition-all duration-300 focus-visible-enhanced disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation select-none",
  {
    variants: {
      variant: {
        ...
        "cta-white": "border-2 border-white text-foreground bg-white hover:bg-white/90 hover:text-navy neumorphic-card-1 transform hover:scale-[1.01] font-bold shadow-lg",
        ...
        "overlay-white": "bg-black/70 text-white border border-white/20 backdrop-blur-sm hover:bg-black/90 neumorphic-card-1 transform hover:scale-[1.01]",
        "modal-control": "bg-black/80 text-white border border-white/30 hover:bg-black/90 shadow-lg min-h-[44px] min-w-[44px]",
        "glass-white": "bg-black/60 text-white border border-white/20 backdrop-blur-md hover:bg-black/80 hover:border-white/40",
