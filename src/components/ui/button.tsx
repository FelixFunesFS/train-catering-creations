  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation select-none",
  {
    variants: {
      ...
      size: {
        ...
        "responsive-sm": "h-9 px-3 text-sm min-h-[44px] min-w-[44px] sm:h-10 sm:px-4 sm:min-h-[44px] sm:min-w-[44px]",
        "responsive-md": "h-9 px-3 text-sm min-h-[44px] min-w-[44px] sm:h-10 sm:px-4 sm:text-sm sm:min-h-[44px] sm:min-w-[44px]",
        "responsive-lg": "h-10 px-4 text-sm min-h-[44px] min-w-[44px] sm:h-11 sm:px-5 sm:text-base sm:min-h-[44px] sm:min-w-[44px]",
        "responsive-xl": "h-11 px-5 text-base min-h-[44px] min-w-[44px] sm:h-12 sm:px-6 sm:text-base sm:min-h-[48px] sm:min-w-[48px]",
      },
    },
    defaultVariants: {
      variant: "default",
