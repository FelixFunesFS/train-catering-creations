  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation select-none",
  {
    variants: {
      ...
      size: {
        ...
        icon: "h-10 w-10",
        "mobile-standard": "min-h-[48px] px-6 py-3 text-base font-semibold w-3/5 sm:w-auto sm:min-w-[14rem] justify-center",
        "responsive-sm": "min-h-[48px] px-6 py-3 text-sm font-medium sm:text-base sm:px-8 w-3/5 sm:w-auto sm:min-w-[14rem] justify-center",
        "responsive-md": "min-h-[48px] px-8 py-3 text-base font-semibold sm:text-base sm:px-10 w-3/5 sm:w-auto sm:min-w-[14rem] justify-center",
        "responsive-lg": "min-h-[48px] px-10 py-3 text-base font-bold sm:text-lg sm:px-12 w-3/5 sm:w-auto sm:min-w-[16rem] justify-center",
        "responsive-xl": "min-h-[52px] px-12 py-4 text-lg font-bold sm:text-xl sm:px-16 w-3/5 sm:w-auto sm:min-w-[16rem] justify-center",
      },
    },
    defaultVariants: {
      variant: "default",
