  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation select-none",
  {
    variants: {
      ...
      size: {
        ...
        icon: "h-10 w-10",
        "responsive-sm": "min-h-[44px] px-4 py-2 text-sm font-medium sm:text-base sm:px-8 w-full sm:w-auto justify-center",
        "responsive-md": "min-h-[44px] px-6 py-2 text-sm font-semibold sm:text-base sm:px-10 w-full sm:w-auto justify-center",
        "responsive-lg": "min-h-[44px] px-8 py-2 text-sm font-bold sm:text-lg sm:px-12 w-full sm:w-auto justify-center",
        "responsive-xl": "min-h-[46px] px-10 py-3 text-base font-bold sm:text-xl sm:px-16 w-full sm:w-auto justify-center",
      },
    },
    defaultVariants: {
      variant: "default",
