...
export const WeddingMenuView = () => {
  // Wedding menu data with elegant descriptions
  const appetizers = [
      ...
      <section className="relative py-12 md:py-20 lg:py-24 bg-muted/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-12">
            <ElegantServiceCard title="Premium Service" items={premiumServiceItems} delay={0} />
            <ElegantServiceCard title="Specialty Options" items={specialtyOptions} delay={150} />
          </div>
        </div>
      </section>
    </div>
