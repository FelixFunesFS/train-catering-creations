        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex justify-between items-center py-1 sm:py-2">
            ...
            <nav className="hidden lg:flex items-center space-x-2" aria-label="Main navigation">
              ...
              <Button asChild variant="secondary" size="sm" className="text-sm font-medium px-4 py-2 rounded-lg bg-white text-primary hover:bg-white/90 neumorphic-card-1">
            ...
            <div className="lg:hidden flex items-center">
              <Button className="bg-transparent hover:bg-transparent text-primary-foreground hover:text-primary-foreground transition-all duration-300 focus-visible-enhanced p-2 h-auto w-auto" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-expanded={isMenuOpen} aria-controls="mobile-menu" aria-label={isMenuOpen ? "Close menu" : "Open menu"}>
                {isMenuOpen ? <X className="h-10 w-10 md:h-12 md:w-12" strokeWidth={2.5} /> : <svg className="h-10 w-10 md:h-12 md:w-12" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="neumorphic-card-2 rounded-xl p-4 mt-4">
                <div className="flex flex-col space-y-3">
                  ...
                  <div className="flex justify-center mt-4">
                    <Button asChild variant="secondary" size="responsive-sm" className="w-3/5 sm:w-auto sm:min-w-[14rem] bg-primary text-primary-foreground hover:bg-primary/90 neumorphic-card-1">
