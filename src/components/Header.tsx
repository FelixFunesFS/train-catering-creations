        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 my-0 py-[9px]">
          <div className="flex justify-between items-center py-1 sm:py-2">
            ...
            <div className="lg:hidden flex items-center">
              <Button className="neumorphic-button bg-transparent hover:bg-muted/30 text-foreground hover:text-foreground transition-all duration-300 focus-visible-enhanced p-4 h-16 w-16" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-expanded={isMenuOpen} aria-controls="mobile-menu" aria-label={isMenuOpen ? "Close menu" : "Open menu"}>
                {isMenuOpen ? <X className="h-10 w-10 md:h-12 md:w-12" strokeWidth={3.5} /> : <svg className="h-10 w-10 md:h-12 md:w-12" fill="none" stroke="white" strokeWidth={3.5} viewBox="0 0 24 24" aria-hidden="true">
