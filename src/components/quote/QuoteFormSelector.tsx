    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className={showHeader ? "grid grid-cols-1 lg:grid-cols-2 gap-8" : "mt-6 sm:mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8"}>
        ...
        <Card className="shadow-elegant hover:shadow-glow transition-all duration-300 hover:scale-[1.02] bg-gradient-to-br from-background via-primary/5 to-accent/10 border-2 border-primary/30 hover:border-primary/50 relative overflow-hidden group">
          ...
          <CardContent className="p-5 lg:p-6 relative z-10">
            <div className="text-center mb-4">
              <div className="inline-flex items-center justify-center w-14 h-14 lg:w-16 lg:h-16 rounded-full bg-primary/15 mb-3 group-hover:bg-primary/20 transition-colors">
                <Users className="h-7 w-7 lg:h-8 lg:w-8 text-primary" />
              </div>
              <h3 className="text-xl lg:text-2xl font-elegant text-foreground mb-2">Regular Events</h3>
        ...
        <Card className="shadow-elegant hover:shadow-glow transition-all duration-300 hover:scale-[1.02] bg-gradient-to-br from-background via-accent/5 to-primary/10 border-2 border-accent/30 hover:border-accent/50 relative overflow-hidden group">
          <div className="absolute top-0 left-0 w-28 h-28 bg-gradient-to-br from-accent/10 to-transparent rounded-br-full" />
          <div className="absolute bottom-0 right-0 w-20 h-20 bg-gradient-to-tl from-primary/10 to-transparent rounded-tl-full" />
          <CardContent className="p-5 lg:p-6 relative z-10">
            <div className="text-center mb-4">
              <div className="inline-flex items-center justify-center w-14 h-14 lg:w-16 lg:h-16 rounded-full bg-accent/15 mb-3 group-hover:bg-accent/20 transition-colors">
                <Heart className="h-7 w-7 lg:h-8 lg:w-8 text-accent" />
              </div>
              <h3 className="text-xl lg:text-2xl font-elegant text-foreground mb-2">Formal & Military Events</h3>
              <p className="text-muted-foreground text-sm lg:text-base">
