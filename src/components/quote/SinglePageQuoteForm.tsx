...
const STEPS = [
  ...
  { id: 'menu_mains', title: 'Menu: Mains', icon: UtensilsCrossed, required: false, fields: ['proteins', 'sides', 'vegetarian_entrees', 'guest_count_with_restrictions'] },
  { id: 'menu_extras', title: 'Menu: Extras', icon: UtensilsCrossed, required: false, fields: ['appetizers', 'desserts', 'drinks'] },
