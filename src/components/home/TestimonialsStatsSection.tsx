  ...
  return <section className="py-6 md:py-8 lg:py-10 bg-gradient-card shadow-card rounded-lg mx-4 sm:mx-6 lg:mx-8 my-4 md:my-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-stretch">
          ...
          {/* Review Side */}
          <div className="bg-card rounded-2xl p-4 sm:p-6 lg:p-8 border border-border shadow-card flex flex-col justify-between h-full px-[27px] py-0">
            <Quote className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-primary mb-6 my-[19px]" />
            ...
            <div>
              ...
              <div className="border-t border-border pt-6 py-0 my-[19px]">
                <p className="text-base sm:text-lg font-semibold text-foreground">
                  Sarah & Michael's Wedding
                </p>
                <p className="text-sm sm:text-base text-muted-foreground my-0 py-0">
                  Charleston, SC
                </p>
              </div>
            </div>
