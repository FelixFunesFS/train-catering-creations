    ...
    <section className="py-8 sm:py-12 lg:py-16 bg-gradient-card/30 border-t border-border/10">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 items-stretch">
          ...
          <div ref={statsRef} className={`lg:col-span-2 space-y-6 sm:space-y-8 ${statsAnimationClass}`}>
          ...
          <div ref={reviewRef} className={`neumorphic-card-2 hover:neumorphic-card-3 rounded-2xl p-4 sm:p-6 lg:p-8 transition-all duration-300 hover:scale-105 group flex flex-col justify-between h-full ${reviewAnimationClass}`}>
