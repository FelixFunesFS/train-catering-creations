...
export const ResponsiveGalleryShowcase = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-background via-ruby-light/5 to-background relative overflow-hidden">
