...
export const FeaturedServiceCard = ({ delay = 0 }: FeaturedServiceCardProps) => {
  ...
  const handleCardClick = () => {
    navigate("/wedding-menu#page-header");
  };

  const handleQuoteClick = (e: React.MouseEvent) => {
    e.stopPropagation();
    navigate("/wedding-event-quote#page-header");
  };
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="text-muted-foreground hover:text-foreground text-sm underline text-left"
            >
              Get Custom Quote
            </button>
          </div>
