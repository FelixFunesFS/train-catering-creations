...
export const StoryHero = () => {
  ...
  return (
    <div className={`relative overflow-hidden bg-gradient-primary ${isMobile ? 'min-h-screen py-8' : 'h-screen'}`}>
      {isMobile ? (
        // Mobile Layout: Image at top, content below
        <div className="flex flex-col items-center">
          {/* Story Progress Indicators - Mobile */}
          ...
          <div className="relative aspect-[5/4] w-full max-w-sm mb-6">
            <OptimizedImage
          ...
          <div className="px-4 text-center">
            ...
            {/* Main Heading */}
            <div className="mb-6">
              <h1 className="text-2xl sm:text-3xl font-elegant font-bold text-white leading-tight mb-2" style={{ textShadow: '0 4px 8px rgba(0, 0, 0, 0.8), 0 2px 4px rgba(0, 0, 0, 0.6), 0 1px 2px rgba(0, 0, 0, 0.4)' }}>
                {typewriterText}
                <span className="animate-pulse">|</span>
              </h1>
              
              <div className="text-lg sm:text-xl font-script text-white mb-4" style={{ textShadow: '0 4px 8px rgba(0, 0, 0, 0.8), 0 2px 4px rgba(0, 0, 0, 0.6), 0 1px 2px rgba(0, 0, 0, 0.4)' }}>
                Catering Experience
              </div>
              
              <div className="w-16 h-1 bg-gradient-ruby-primary mb-4 rounded-full mx-auto" />
              
              <h2 className="text-lg font-elegant font-semibold text-white mb-2" style={{ textShadow: '0 3px 6px rgba(0, 0, 0, 0.7), 0 1px 3px rgba(0, 0, 0, 0.5)' }}>
                {currentImage.title}
              </h2>
              
              <p className="text-white/80 text-sm max-w-sm mx-auto" style={{ textShadow: '0 2px 4px rgba(0, 0, 0, 0.6), 0 1px 2px rgba(0, 0, 0, 0.4)' }}>
        ...
        // Desktop Layout: Full screen with overlay
        <>
          ...
          {/* Story Progress Indicators - Desktop */}
          ...
          <div 
            ref={overlayRef}
            className={`absolute inset-0 flex flex-col justify-end p-4 sm:p-6 lg:p-8 z-15 ${useAnimationClass(overlayVariant, overlayVisible)}`}
          >
            {/* Category Badge */}
            <div className="mb-4">
              <Badge className={`${getCategoryBadge(currentImage.category).variant} backdrop-blur-sm`}>
            ...
            {/* Main Heading */}
            <div className="mb-6">
              <h1 className="text-3xl lg:text-5xl xl:text-6xl font-elegant font-bold text-white leading-tight mb-2" style={{ textShadow: '0 4px 8px rgba(0, 0, 0, 0.8), 0 2px 4px rgba(0, 0, 0, 0.6), 0 1px 2px rgba(0, 0, 0, 0.4)' }}>
                {typewriterText}
                <span className="animate-pulse">|</span>
              </h1>
              
              <div className="text-2xl lg:text-4xl xl:text-5xl font-script text-white mb-4" style={{ textShadow: '0 4px 8px rgba(0, 0, 0, 0.8), 0 2px 4px rgba(0, 0, 0, 0.6), 0 1px 2px rgba(0, 0, 0, 0.4)' }}>
                Catering Experience
              </div>
              
              <div className="w-16 lg:w-24 h-1 bg-gradient-ruby-primary mb-4 rounded-full" />
              
              <h2 className="text-xl lg:text-2xl font-elegant font-semibold text-white mb-2" style={{ textShadow: '0 3px 6px rgba(0, 0, 0, 0.7), 0 1px 3px rgba(0, 0, 0, 0.5)' }}>
                {currentImage.title}
              </h2>
              
              <p className="text-white/80 text-base lg:text-lg max-w-lg" style={{ textShadow: '0 2px 4px rgba(0, 0, 0, 0.6), 0 1px 2px rgba(0, 0, 0, 0.4)' }}>
                {currentImage.description}
              </p>
            </div>
