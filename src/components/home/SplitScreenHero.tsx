          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-2 md:gap-10 lg:gap-12 items-center min-h-[50vh] md:min-h-screen py-0">
            ...
            <div className="order-2 md:order-1 text-center md:text-left">
              ...
              <div className="mb-4 md:mb-9 lg:mb-10">
                <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl font-elegant font-bold text-foreground leading-tight mb-4">Charleston's Premier Catering Services</h1>
