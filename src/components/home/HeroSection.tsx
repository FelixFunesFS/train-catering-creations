        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <div className="relative z-10 text-center space-y-4 sm:space-y-6 lg:space-y-8 py-6 sm:py-8 lg:py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in">
              <Button asChild variant="cta" className="w-56 h-12 flex items-center justify-center">
                <Link to="/request-quote#page-header">
                  Request Quote
                </Link>
              </Button>
              <Button asChild variant="cta-outline" className="w-56 h-12 flex items-center justify-center">
