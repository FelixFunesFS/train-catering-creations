    ...
    <section className="relative bg-gradient-hero py-24 lg:py-40 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center">
          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-8 lg:p-12 mx-auto max-w-5xl">
            <h1 className="text-5xl lg:text-7xl font-elegant font-bold text-white mb-8 drop-shadow-lg">
