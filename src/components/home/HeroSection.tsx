    ...
    <>
      <section className="py-6 sm:py-8 lg:py-12">
        <ResponsiveWrapper hasFullWidthCard>
          ...
          <div className="relative mb-8 pt-2 sm:pt-4 md:pt-8">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="mb-6 animate-fade-in">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-elegant text-foreground leading-tight">
              ...
              <div className="mb-8 animate-fade-in">
                <p className="text-xl sm:text-2xl lg:text-3xl text-muted-foreground font-elegant leading-relaxed">
