          ...
          <div className="max-w-7xl mx-auto px-6 xl:px-12 w-full">
            <div className="text-center md:text-left max-w-2xl mx-auto md:mx-0">
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 md:p-10 lg:p-12 shadow-2xl">
                {/* Main Heading */}
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-sans font-bold text-white leading-tight mb-6">
                ...
                {/* Subtext */}
                <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/90 font-sans leading-relaxed mb-8">
