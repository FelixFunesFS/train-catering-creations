...
export const LocalConnectionSection = () => {
  ...
  return (
    <section 
      ref={ref}
      className="py-16 lg:py-24 bg-gradient-pattern-a"
      aria-label="Charleston local connection"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 mb-16">
          {charlestonHighlights.map((highlight, index) => (
            <NeumorphicCard 
              key={index}
              level={1}
              interactive
              className="p-4 lg:p-6 text-center group hover:neumorphic-card-2 transition-all duration-300"
            >
