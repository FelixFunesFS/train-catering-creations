          ...
          <div>
            ...
            <nav className="space-y-2">
              {navigationLinks.map(item => (
                <Link key={item.name} to={item.href} className="block text-sm text-muted-foreground hover:text-primary hover:translate-x-1 transition-all duration-200">
                  {item.name}
                </Link>
              ))}
            </nav>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex space-x-3">
                <a href="#" className="w-8 h-8 neumorphic-button rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:scale-110 transition-all duration-200" aria-label="Facebook">
                  <Facebook className="h-4 w-4" />
                </a>
                <a href="#" className="w-8 h-8 neumorphic-button rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:scale-110 transition-all duration-200" aria-label="Instagram">
                  <Instagram className="h-4 w-4" />
                </a>
                <a href="#" className="w-8 h-8 neumorphic-button rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:scale-110 transition-all duration-200" aria-label="Twitter">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-0">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-primary-foreground">
            ...
            <div className="flex flex-wrap space-x-3 mt-2 sm:mt-0 text-center sm:text-right">
              <Link to="/privacy-policy" className="text-primary-foreground hover:text-primary-foreground/80 transition-colors duration-200">Privacy Policy</Link>
              <span className="text-primary-foreground">|</span>
              <Link to="/terms-conditions" className="text-primary-foreground hover:text-primary-foreground/80 transition-colors duration-200">Terms & Conditions</Link>
            </div>
          </div>
        </div>
      </div>
